...
<%--Lines 27-28, used the JSP expression to retrieves the monthluPayment and totalPayment from the JSP scriptlet to display
    the user monthtlu payment and total payment --%>
